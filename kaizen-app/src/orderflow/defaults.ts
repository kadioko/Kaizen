...
export const seedSetupTemplates: SetupTemplate[] = [
  {
    ...
    newsRisk: false,
    minimumScore: 72,
    notes: 'Use for demand or supply reactions after London liquidity sweeps and failed continuation.',
  },
  {
    id: generateId(),
    name: 'NY AM Gold Continuation',
    instrument: 'XAUUSD',
    session: 'New York AM',
    bias: 'Bullish',
    riskContext: 'Risk-On',
    newsRisk: false,
    minimumScore: 75,
    notes: 'Use for XAUUSD continuation only when VWAP or prior high holds and delta re-accelerates.',
  },
  {
    id: generateId(),
    name: 'Forex Major Fade Framework',
    instrument: 'Any',
    session: 'London',
    bias: 'Neutral',
    riskContext: 'Balanced',
    newsRisk: false,
    minimumScore: 70,
    notes: 'Wait for extremes into value and require absorption before engaging majors.',
  },
];
