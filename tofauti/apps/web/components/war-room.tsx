...
export function WarRoom() {
  ...
  return <main className="terminal-grid min-h-screen bg-[#0d0b13] text-zinc-100"><div className="mx-auto max-w-[1550px] px-4 py-5 sm:px-6 lg:px-8">
    ...
    <div className="mt-5"><HowToUseCard /></div>
