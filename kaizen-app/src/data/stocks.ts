...
export const STOCKS: Stock[] = [
  ...
  { symbol: 'USDCHF', name: 'US Dollar / Swiss Franc', price: 0.8824, change: 0.0018, changePercent: 0.20, volume: 41800000, high: 0.8841, low: 0.8793, open: 0.8806, previousClose: 0.8806, sector: 'Forex', assetClass: 'forex', quoteUnit: 'rate' },
  { symbol: 'AUDUSD', name: 'Australian Dollar / US Dollar', price: 0.6618, change: -0.0021, changePercent: -0.32, volume: 37700000, high: 0.6649, low: 0.6602, open: 0.6639, previousClose: 0.6639, sector: 'Forex', assetClass: 'forex', quoteUnit: 'rate' },
  { symbol: 'USDCAD', name: 'US Dollar / Canadian Dollar', price: 1.3492, change: 0.0027, changePercent: 0.20, volume: 35200000, high: 1.3511, low: 1.3458, open: 1.3465, previousClose: 1.3465, sector: 'Forex', assetClass: 'forex', quoteUnit: 'rate' },
  { symbol: 'NZDUSD', name: 'New Zealand Dollar / US Dollar', price: 0.6127, change: -0.0014, changePercent: -0.23, volume: 22100000, high: 0.6149, low: 0.6108, open: 0.6141, previousClose: 0.6141, sector: 'Forex', assetClass: 'forex', quoteUnit: 'rate' },
  { symbol: 'EURGBP', name: 'Euro / British Pound', price: 0.8530, change: 0.0011, changePercent: 0.13, volume: 24600000, high: 0.8546, low: 0.8512, open: 0.8519, previousClose: 0.8519, sector: 'Forex', assetClass: 'forex', quoteUnit: 'rate' },
  { symbol: 'EURJPY', name: 'Euro / Japanese Yen', price: 162.68, change: -0.38, changePercent: -0.23, volume: 31500000, high: 163.12, low: 162.21, open: 163.06, previousClose: 163.06, sector: 'Forex', assetClass: 'forex', quoteUnit: 'rate' },
  { symbol: 'GBPJPY', name: 'British Pound / Japanese Yen', price: 190.71, change: -0.64, changePercent: -0.33, volume: 28700000, high: 191.42, low: 190.28, open: 191.35, previousClose: 191.35, sector: 'Forex', assetClass: 'forex', quoteUnit: 'rate' },
